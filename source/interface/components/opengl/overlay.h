...
class OverlayBackgroundRenderer : public OpenGlComponent {
  public:
    ...
    virtual void init(OpenGlWrapper& open_gl) override {
      ...
      open_gl.context.extensions.glBufferData(juce::gl::GL_ARRAY_BUFFER, vert_size, data_, juce::gl::GL_STATIC_DRAW);
  ...
  protected:
    void drawOverlay(OpenGlWrapper& open_gl) {
      ...
      open_gl.context.extensions.glVertexAttribPointer(position_->attributeID, kNumFloatsPerVertex, juce::gl::GL_FLOAT,
