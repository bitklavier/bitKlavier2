...
// {
// public:
//     OpenGL_WaveDistUndertowSlider (chowdsp::ParameterListeners &listeners) : OpenGlAutoImageComponent<BKWaveDistanceUndertowSlider>(
//                                                                             "Wave Distance and Undertow", // slider name
//                                                                             0, // min
//                                                                             20000, // max
//                                                                             -12, // default min
//                                                                             12, // default max
