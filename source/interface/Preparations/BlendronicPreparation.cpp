...
BlendronicPreparation::BlendronicPreparation (juce::ValueTree v, OpenGlWrapper& open_gl, juce::AudioProcessorGraph::NodeID node, SynthGuiInterface* _synth_gui_interface) : PreparationSection (juce::String ("blendronic"), v, open_gl, node, *_synth_gui_interface->getUndoManager())
