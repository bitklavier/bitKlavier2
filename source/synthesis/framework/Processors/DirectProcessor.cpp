...
//    DBG("vel min" + state.params.velocityMinMax.velocityMinParam->getCurrentValueAsText());
//    DBG("vel max" + state.params.velocityMinMax.velocityMaxParam->getCurrentValueAsText());
