...
#ifndef BITKLAVIER2_TEMPOPROCESSOR_H
#define BITKLAVIER2_TEMPOPROCESSOR_H
...
struct TempoParams : chowdsp::ParamHolder
{
    ...
    // Adds the appropriate parameters to the Tempo Processor
    TempoParams()
    {
...
#endif //BITKLAVIER2_TEMPOPROCESSOR_H
