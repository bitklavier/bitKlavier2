...
#include <array>
    ...
    */
    ...
    typedef enum TuningSystem {
        ...
        Quarter_Comma_Meantone = 1 << 14,
        Split_Wolf_QC_Meantone = 1 << 15,
        Transposing_QC_Meantone = 1 << 16,
        Corrette = 1 << 17,
        Rameau = 1 << 18,
        Marpourg = 1 << 19,
        Eggars_English_Ord = 1 << 20,
        Third_Comma_Meantone = 1 << 21,
...
// Create the mapping
    constexpr std::array<std::pair<TuningSystem, std::array<float, 12>>, 37> tuningMap = {{
        ...
        {TuningSystem::Quarter_Comma_Meantone, tQuarterCommaMeantone},
        {TuningSystem::Split_Wolf_QC_Meantone, tSplitWolfQCMeantone},
        ...
        {TuningSystem::Third_Comma_Meantone, tThirdCommaMeantone},
        ...
        {TuningSystem::Bach_Barnes, tBachBarnes},
        {TuningSystem::Neidhardt, tNeidhardt},
        {TuningSystem::Bach_Lehman, tBachLehman},
        {TuningSystem::Bach_ODonnell, tBachODonnell},
        {TuningSystem::Bach_Hill, tBachHill},
        {TuningSystem::Bach_Swich, tBachSwich},
        {TuningSystem::Lambert, tLambert},
        {TuningSystem::Eighth_Comma_WT, tEighthCommaWT},
