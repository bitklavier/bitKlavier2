...
- [ ] how is BinaryData.h autogenerated, as it says in its comments? i'm assuming we can export the svg layers from Illustrator
  ...
  - anyhow, yes that stuff should be autogenerated assets/svg files
